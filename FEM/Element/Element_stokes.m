    ...
    methods (Access = ?Physical_Problem)
        ...
        function K = compute_K(obj,dim,nelem,geometry_test,geometry_variable,material)
            ...
            for igauss = 1 :geometry_variable.ngaus
                ...
                [obj.B, Bmat] = obj.B.computeB(nunkn,nelem,geometry_variable.nnode,geometry_variable.cartDeriv(:,:,:,igauss));
...
%                             for jnode_test = 1:geometry_test.nnode
%                                 for jdime = 1:geometry_test.ndime
%                                 v= squeeze (geometry_test.cartDeriv(jdime,jnode_test,:,igauss));
...
%             obj.LHS= zeros(nunkn*geometry.nnode+1,nunkn*geometry.nnode+1,nelem);
